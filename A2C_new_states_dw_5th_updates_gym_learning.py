# -*- coding: utf-8 -*-
"""Copy of DW_5th_updates_gym_learning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tVOTVz9nPl8q1O26HAxElsScZ2w0KuWh
"""
...
class SatelliteRoutingEnv(gym.Env):
    def __init__(self):
        ...
        self.num_satellites = self.P*self.S
    ...
    def reset(self):
        # reset to  DWconfiguration
        self.state = self._generate_random_state()

        # regen  with the new parameters
...
model = A2C.load("a2c_satellite_routing")
...
for lr, gamma, timesteps in product(learning_rates, gammas, total_timesteps_list):
    ...
    model = A2C("MlpPolicy", env, learning_rate=lr, gamma=gamma, verbose=0)
